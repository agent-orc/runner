...
/// <summary>
/// CAR's supported pipe-based process-spawner API. Use it to inspect, validate,
/// or decorate the prepared <see cref="ProcessStartInfo"/> without replacing the
/// library's platform-specific launch behavior.
/// </summary>
/// <remarks>
/// On Windows this uses CAR's curated-handle spawn path; on other platforms it uses
/// the same redirected-pipe <see cref="Process.Start(ProcessStartInfo)"/> behavior
/// as the runner default. A decorator callback runs after CAR has prepared the
/// executable, arguments, environment, working directory, and redirect policy.
/// </remarks>
